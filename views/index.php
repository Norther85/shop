...
<head>
    ...
    <title>TRILOCOR Shop | Home</title>
...
<body>
    ...
    <div class="site-header-bg">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <a href="/"><img src="/assets/images/logo.png" alt="logo" style="width:50%"></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="intro row">
                ...
                <div class="col-sm-6 col-sm-offset-6">
                    ...
                    <p>Your sweeping costs with</p>
                    <h1 class="header-title">Trilocor<br><span class="thin">Robotics</span></h1>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="classic-title">
                        ...
                        <h3 class="outer-stiker">We Received best factory award in the 2020 and 2021</h3>
                ...
                <div class="boxed">
                    <div class="col-sm-4">
                        <p class="p-large">
                            Automation can seem daunting, but it doesn't need to be. Our cutting-edge robots are designed so that even beginners can use them. Simple, intuitive features mean that anyone can rapidly become a robotics expert, and help increase productivity.
                        </p>
                    </div>
                    <div class="col-sm-4">
                        <p>
                            In 53 countries, across every industry imaginable, we've been in the robotics game for longer than just about anyone else out there. And we bring all of that expertise to your unique needs, ideas, and goals.
                        </p>
                    </div>
                    <div class="col-sm-4">
                        <p>
                            No unanswered emails. No hidden phone numbers. We always offer you real-life, very-human support. Whatever you need, we've got the experience, tools, and real-life, real-helpful human experts ready to support you. Together, the future's easier.
                        </p>
                    </div>
                </div>
            </div>
